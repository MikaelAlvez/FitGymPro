...
export function StepExperience({ form, onSubmit, onBack }: Props) {
    ...
    <View style={styles.container}>
      ...
      <Controller control={control} name="experience"
        render={({ field: { onChange, value } }) => (
          <SelectCardGroup options={OPTIONS} value={value} onChange={onChange} error={errors.experience?.message} />
        )}
      />
