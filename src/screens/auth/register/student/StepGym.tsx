...
const OPTIONS: CardOption<GymType>[] = [
  { value: 'basic',    title: 'Academia básica:',    description: 'Equipamentos simples, como barras e alteres' },
  { value: 'advanced', title: 'Academia avançada:',  description: 'Academia completa com todos os equipamentos e máquinas' },
];

interface Props { form: UseFormReturn<StepGymData>; onSubmit: (d: StepGymData) => void; }
...
export function StepGym({ form, onSubmit }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Controller control={control} name="gymType"
