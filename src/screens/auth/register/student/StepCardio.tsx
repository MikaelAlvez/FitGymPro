...
interface Props { form: UseFormReturn<StepCardioData>; onSubmit: (d: StepCardioData) => void; }

export function StepCardio({ form, onSubmit }: Props) {
