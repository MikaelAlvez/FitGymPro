...
const OPTIONS: CardOption<CardioOption>[] = [
  {
    value:       'include',
    title:       'Incluir cardio:',
    description: 'Exercícios de cardio serão adicionados antes ou após treino',
  },
  {
    value:       'exclude',
    title:       'Não incluir cardio:',
    description: 'Não será incluso exercícios de esteira, bicicleta e semelhantes',
  },
];
